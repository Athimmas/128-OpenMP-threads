...
!      endif
        ...
        kk=1
            ...
            !$OMP PARALLEL DO DEFAULT(SHARED)PRIVATE(j,i,KMASKE,KMASKN,tempi,tempip1,tempj,tempjp1)NUM_THREADS(48)
            do j=1,ny_block
              do i=1,nx_block
...
!-------------------------------------------------------------------------
        ...
        do kk=1,km
            ...
            !$OMP PRIVATE(txpim1,txim1,temp_ksjm1,kmasknjm1,typjm1,tyjm1)NUM_THREADS(48)
            do j=1,ny_block
              do i=1,nx_block
...
!-----------------------------------------------------------------------
        ...
        if(k==1)then
          ...
          do n=3,nt 
           !$OMP PARALLEL DO DEFAULT(SHARED)PRIVATE(kk,n,j,i)collapse(2)NUM_THREADS(48)
           do kk=1,km-1
             do j=1,ny_block
                do i=1,nx_block
