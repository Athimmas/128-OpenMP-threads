...
!-----------------------------------------------------------------------
      ...
      TEMP   = c0
        ...
        kk=1
            ...
            !$OMP PARALLEL DO DEFAULT(SHARED)PRIVATE(j,i,KMASKE,KMASKN,tempi,tempip1,tempj,tempjp1)num_threads(4)
            do j=1,ny_block
              do i=1,nx_block
...
!-------------------------------------------------------------------------
        ...
        do kk=1,km
            ...
            !$OMP PRIVATE(txpim1,txim1,temp_ksjm1,kmasknjm1,typjm1,tyjm1)NUM_THREADS(4)
            do j=1,ny_block
              do i=1,nx_block
